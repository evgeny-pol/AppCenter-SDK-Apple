...
@interface MSAssets () <MSServiceInternal, MSChannelDelegate>
 ...
 */
+ (void)trackEvent:(NSString *)eventName forTransmissionTarget:(nullable MSAssetsTransmissionTarget *)transmissionTarget;
