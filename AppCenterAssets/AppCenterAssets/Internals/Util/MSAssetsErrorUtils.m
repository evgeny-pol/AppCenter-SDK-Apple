...
+ (NSError *)getNoDirError: (NSString *)folderPath {
    ...
    return [NSError errorWithDomain:kMSACAssetsErrorDomain code:kMSACFileErrorCode userInfo:userInfo];
}
...
+ (NSError *)getNoSignatureError:(NSString *)signaturePath {
    ...
    return [NSError errorWithDomain:kMSACAssetsErrorDomain code:kMSACSignatureVerificationErrorCode userInfo:userInfo];
}
...
+ (NSError *)getDownloadPackageError:(NSString *)downloadUrl statusCode:(NSInteger)statusCode {
    NSDictionary *userInfo = @{kMSACAssetsDownloadCodeErrorKey : kMSACDownloadPackageStatusCodeErrorDesc(downloadUrl, (long)statusCode)};
    return [NSError errorWithDomain:kMSACAssetsErrorDomain code:kMSACDownloadPackageErrorCode userInfo:userInfo];
}

+ (NSError *)getDownloadPackageError:(NSString *)downloadUrl {
    NSDictionary *userInfo = @{kMSACAssetsDownloadCodeErrorKey : kMSACDownloadPackageErrorDesc(downloadUrl)};
    return [NSError errorWithDomain:kMSACAssetsErrorDomain code:kMSACDownloadPackageErrorCode userInfo:userInfo];
}

+ (NSError *)getDownloadPackageErrorFilePath:(NSString *)filePath {
    NSDictionary *userInfo = @{kMSACAssetsDownloadCodeErrorKey : kMSACDownloadPackageInvalidFileErrorDesc(filePath)};
    return [NSError errorWithDomain:kMSACAssetsErrorDomain code:kMSACDownloadPackageErrorCode userInfo:userInfo];
...
+ (NSError *)getUpdateParseError {
    ...
    return [NSError errorWithDomain:kMSACAssetsErrorDomain code:kMSACQueryUpdateErrorCode userInfo:userInfo];
}
...
+ (NSError *)getNoPackageHashToInstallError {
    ...
    return [NSError errorWithDomain:kMSACAssetsErrorDomain code:kMSACInstallErrorCode userInfo:userInfo];    
}
...
+ (NSError *)getNoAppVersionError {
    ...
    return [NSError errorWithDomain:kMSACAssetsErrorDomain code:kMSACParseErrorCode userInfo:userInfo];
}
@end
